...
#The old verification window, rendered obsolete with the switch over to verif1/verif2. Contains lots of useful code if you're wondering where certain plan elements are kept.       
