# -*- coding: utf-8 -*-
"""
Ajoute les objectifs d'optimisation pour les cas de stéréo de crane.
...
.. seealso::
  la documentation de la fonction :py:func:`optimization_objectives.add_opt_obj_brain_stereo` pour les détails.
"""
...
with lib.RSScriptWrapper(__file__):
    optimization_objectives.add_opt_obj_brain_stereo()
